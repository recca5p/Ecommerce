...
public sealed class RepositoryManager : IRepositoryManager
{
    ...
    private readonly Lazy<IPaymentRepository> _lazyPaymentRepository; // Th�m d�ng n�y
    private readonly Lazy<IReviewRepository> _lazyReviewRepository;   // Th�m d�ng n�y
    ...
    public RepositoryManager(IRepositoryDbContext repositoryDbContext)
    {
        ...
        _lazyPaymentRepository = new Lazy<IPaymentRepository>(() => new PaymentRepository(repositoryDbContext)); // Th�m d�ng n�y
        _lazyReviewRepository = new Lazy<IReviewRepository>(() => new ReviewRepository(repositoryDbContext));    // Th�m d�ng n�y
